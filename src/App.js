...
function App() {
  ...
  let signUpMessage = useRef(false)
  ...
  return (
    <div className="App">
        <Context.Provider value={{'loggedInUser': loggedInUser, 'dispatchUser': dispatchUser, 'defaultImage': defaultImage, 'colorTemplate': colorTemplate, 'signUpMessage': signUpMessage}}>
      <header>
        <NavBar />
      </header>
      <main>
