...
const SignUp = () => {
  ...
  return (
    <div className=''>
      {success ? 
        <div
        className='start-container white-bg w-80 md:w-2/5 p-4 text-center'>
      ...
      : 
        <div className='start-container white-bg w-72 md:w-96 p-5 space-y-4'>
          ...
          >
            ...
            <Row>
              <button  
                className='account-button w-20 mb-2 text-sm md:text-base'
                type='submit'
              >Submit</button>
            </Row>
          </form>
